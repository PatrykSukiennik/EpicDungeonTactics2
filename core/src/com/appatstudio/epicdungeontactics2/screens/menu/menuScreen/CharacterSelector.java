...
public final class CharacterSelector {
    ...
    public static final float iconSize = EpicDungeonTactics.isTablet() ? Gdx.graphics.getWidth() * 0.4f : Gdx.graphics.getWidth()/2f;
        ...
        if (leftArrow.tap(x, y)) {
            ...
            if (characterCards[currectIndex].isUnlocked) {
                if (startButton.tap(x, y)) {
                    ...
                    SoundsManager.playSound(SoundEnum.INTERFACE_TAP);
                    return true;
                }
