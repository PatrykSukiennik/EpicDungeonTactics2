...
public class CategoryButton {
    ...
    void draw(Batch batch, boolean isSelected, float y) {
        if (!isSelected) {
            ...
            bg.draw(batch, AbstractSegment.getPosX(), y, CategoryColumns.getW(), CategoryColumns.getSegmentH());
            batch.getColor().a = 1f;
            batch.end();
            batch.begin();
        }
        else bg.draw(batch, AbstractSegment.getPosX(), y, CategoryColumns.getW(), CategoryColumns.getSegmentH());
    }
