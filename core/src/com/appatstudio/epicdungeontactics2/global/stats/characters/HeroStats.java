...
public final class HeroStats {
    ...
    static {
        ...
        pointsPerLvlMap.put(CharacterEnum.HERO_ELF, 2);
        pointsPerLvlMap.put(CharacterEnum.HERO_KNIGHT, 2);
        pointsPerLvlMap.put(CharacterEnum.HERO_WIZZARD, 3);
        pointsPerLvlMap.put(CharacterEnum.HERO_LIZARD, 4);
        pointsPerLvlMap.put(CharacterEnum.HERO_NINJA, 4);
        pointsPerLvlMap.put(CharacterEnum.HERO_PIRATE, 4);
        pointsPerLvlMap.put(CharacterEnum.HERO_BABY, 8);
        ...
        requiredStageToUnlockMap.put(CharacterEnum.HERO_WIZZARD, 2);
        requiredStageToUnlockMap.put(CharacterEnum.HERO_LIZARD, 4);
        requiredStageToUnlockMap.put(CharacterEnum.HERO_NINJA, 5);
        requiredStageToUnlockMap.put(CharacterEnum.HERO_PIRATE, 5);
        requiredStageToUnlockMap.put(CharacterEnum.HERO_BABY, 5);
        ...
        startingItemMap.put(CharacterEnum.HERO_ELF, new ItemEnum[]{ItemEnum.BOWv0, ItemEnum.FOODv3, ItemEnum.FOODv3});
        ...
        startingItemMap.put(CharacterEnum.HERO_BABY, new ItemEnum[]{ItemEnum.STAFFv3, ItemEnum.FOODv0, ItemEnum.FOODv0});
