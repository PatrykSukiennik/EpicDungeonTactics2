...
public class BodyConfig {
    ...
    static {
        ...
        characterBodyDef.put(OGRE, smallBody);
        ...
        characterBodyDef.put(BIG_DEMON, smallBody);
        ...
        characterBodyDef.put(FOREST_GUARDIAN, smallBody);
        ...
        characterFixtureDef.put(OGRE, smallFixtureDef);
        ...
        characterFixtureDef.put(BIG_DEMON, smallFixtureDef);
        ...
        characterFixtureDef.put(FOREST_GUARDIAN, smallFixtureDef);
